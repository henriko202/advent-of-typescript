...
Starting off with a simple union type with two string literals that only accepts the two flavors of cookies that Santa likes, "ginger-bread" and "chocolate-chip", any other cookie will throw a compile-time error.
